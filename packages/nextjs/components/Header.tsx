      ...
      <div className="navbar-start w-auto lg:w-1/2 self-stretch">
        ...
        <Link href="/" passHref className="hidden lg:flex items-center gap-2 ml-4 mr-6 shrink-0">
          <div className="flex relative w-10 h-10">
            <Image alt="Clawd Achievements logo" className="cursor-pointer" fill src="/logo.svg" />
          </div>
          <div className="flex flex-col">
            <span className="font-bold leading-tight">Clawd Achievements</span>
            <span className="text-xs">Onchain achievement badges</span>
          </div>
        </Link>
